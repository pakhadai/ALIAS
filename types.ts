...
export interface GameActionPayload {
  action: 'CORRECT' | 'SKIP' | 'START_GAME' | 'START_DUEL' | 'START_ROUND' | 'START_PLAYING' | 'NEXT_ROUND' | 'RESET_GAME' | 'REMATCH' | 'UPDATE_SETTINGS' | 'GENERATE_TEAMS' | 'PAUSE_GAME' | 'KICK_PLAYER' | 'TIME_UP' | 'CONFIRM_ROUND' | 'ADD_OFFLINE_PLAYER' | 'REMOVE_OFFLINE_PLAYER';
  data?: any;
}
