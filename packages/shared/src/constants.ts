...
export const MOCK_WORDS: Record<Language, Partial<Record<Category, string[]>>> = {
  [Language.UA]: {
    ...
    [Category.GENERAL]: [
      ...
      'Парк', 'Фонтан', "Пам'ятник", 'Площа', 'Вулиця', 'Провулок', 'Набережна', 'Ліс', 'Поле', 'Озеро',
      ...
      'Рука', 'Нога', 'Голова', 'Очі', 'Вухо', 'Ніс', 'Рот', 'Зуб', 'Волосся', 'Обличчя',
      'Плече', 'Лікоть', 'Долоня', 'Палець', 'Коліно', 'Ступня', 'Спина', 'Живіт', 'Шия', 'Пульс',
      'Мозок', 'Кістка', 'М’яз', 'Шкіра', 'Кров', 'Легені', 'Печінка', 'Нирка', 'Шлунок', 'Горло',
      'Місто', 'Село', 'Країна', 'Дім', 'Квартира', 'Кімната', 'Кухня', 'Ванна', 'Балкон', 'Коридор',
      'Дах', 'Стіна', 'Підлога', 'Стеля', 'Килим', 'Штора', 'Полиця', 'Шафа', 'Комод', 'Скриня',
      'Холодильник', 'Плита', 'Духовка', 'Мікрохвильовка', 'Чайник', 'Тостер', 'Блендер', 'Міксер', 'Кавоварка', 'Пилосос',
      'Пральна машина', 'Сушарка', 'Праска', 'Фен', 'Гребінець', 'Зубна щітка', 'Мило', 'Шампунь', 'Рушник', 'Губка',
      'М’ячик', 'Кубики', 'Лялька', 'Конструктор', 'Пазл', 'Картки', 'Настільна гра', 'Доміно', 'Кубик', 'Фішка',
      'Блокнот', 'Журнал', 'Газета', 'Казка', 'Роман', 'Вірш', 'Лист', 'Конверт', 'Марка', 'Плакат',
      'Атлас', 'Глобус', 'План', 'Схема', 'Портрет', 'Картина', 'Скульптура', 'Музика', 'Пісня', 'Мелодія',
      'Скрипка', 'Піаніно', 'Барабан', 'Труба', 'Флейта', 'Саксофон', 'Гармошка', 'Бандура', 'Укулеле', 'Контрабас',
      'Сорочка', 'Футболка', 'Куртка', 'Пальто', 'Светр', 'Шарф', 'Шапка', 'Рукавичка', 'Шкарпетка', 'Взуття',
      'Черевик', 'Кросівок', 'Туфля', 'Сандаля', 'Чобіт', 'Капелюх', 'Пояс', 'Сукня', 'Спідниця', 'Штани',
      'Джинси', 'Шорти', 'Піджак', 'Краватка', 'Піжама', 'Халат', 'Парасоля', 'Гудзик', 'Нитка', 'Кишеня',
      'Сніданок', 'Обід', 'Вечеря', 'Перекус', 'Голод', 'Спрага', 'Смак', 'Запах', 'Тепло', 'Холод',
      'Ранок', 'День', 'Вечір', 'Ніч', 'Світанок', 'Захід', 'Тиждень', 'Доба', 'Рік', 'Секунда',
      'Хвилина', 'Година', 'Календар', 'Будильник', 'Свято', 'День народження', 'Весілля', 'Похід', 'Пікнік', 'Вечірка',
      'Лікар', 'Вчитель', 'Студент', 'Майстер', 'Кухар', 'Пекар', 'Водій', 'Пілот', 'Будівельник', 'Перукар',
      'Програміст', 'Дизайнер', 'Інженер', 'Архітектор', 'Фермер', 'Пожежник', 'Поліцейський', 'Бухгалтер', 'Касир', 'Охоронець',
      'Зоопарк', 'Супермаркет', 'Поліклініка', 'Гімназія', 'Садок', 'Стадіон', 'Театр', 'Кіно', 'Кафе', 'Ресторан',
      'Алея', 'Сквер', 'Пляж', 'Річка', 'Ставок', 'Діброва', 'Гай', 'Луг', 'Степ', 'Пагорб',
      'Яр', 'Стежка', 'Дорога', 'Тротуар', 'Перехід', 'Світлофор', 'Знак', 'Мапа', 'Навігатор', 'Маршрут',
      'Подарунок', 'Сюрприз', 'Листівка', 'Квиток', 'Чек', 'Рахунок', 'Ціна', 'Знижка', 'Реклама', 'Вивіска',
      'Камера', 'Фото', 'Відео', 'Кнопка', 'Флешка', 'Провід', 'Розетка', 'Батарейка', 'Зарядка', 'Ліхтарик',
      'Молоток', 'Цвях', 'Гвинт', 'Викрутка', 'Плоскогубці', 'Пилка', 'Дриль', 'Рулетка', 'Рівень', 'Драбина',
      'Фарба', 'Пензель', 'Скотч', 'Маркер', 'Гумка', 'Крейда', 'Папка', 'Портфель', 'Скобка', 'Степлер',
      'Погодні', 'Прогноз', 'Температура', 'Тиск', 'Вологість', 'Клімат', 'Сезон', 'Весна', 'Літо', 'Осінь',
      'Зима', 'Снігопад', 'Злива', 'Гроза', 'Буря', 'Шквал', 'Ураган', 'Сонячно', 'Хмарно', 'Вітряно',
      'Кора', 'Листя', 'Гілка', 'Корінь', 'Насіння', 'Плід', 'Квітка', 'Пелюстка', 'Пилок', 'Стебло',
      'Мураха', 'Бджола', 'Метелик', 'Павук', 'Комар', 'Муха', 'Жук', 'Коник', 'Гусінь', 'Божа корівка',
      'Риба', 'Птах', 'Кінь', 'Корова', 'Коза', 'Вівця', 'Свиня', 'Курка', 'Півень', 'Гуска',
      'Качка', 'Індик', 'Кролик', 'Їжак', 'Білка', 'Бобер', 'Видра', 'Лось', 'Кабан', 'Тигр',
      'Пантера', 'Леопард', 'Крокодил', 'Черепаха', 'Змія', 'Ящірка', 'Жаба', 'Дельфін', 'Кит', 'Акула',
    ],
    [Category.FOOD]: [
      ...
      'Сіль', 'Кориця', 'Ваніль', 'Базилік', 'Укроп', 'Петрушка', "М'ята", 'Розмарин', 'Імбир', 'Орегано',
    ...
    [Category.TRAVEL]: [
      ...
      'Вокзал', 'Порт', 'Кемпінг', 'Хостел', 'Мотель', 'Курорт', 'Сувенір', 'Подорож', 'Пригода', 'Відпочинок',
    ],
    [Category.SCIENCE]: [
    ...
    [Category.MOVIES]: [
      ...
      'Мультфільм', 'Кінотеатр', 'Детектив', 'Трилер', 'Жахи', 'Мелодрама', 'Фантастика', 'Документальний',
    ],
  },
  [Language.DE]: {
    [Category.GENERAL]: [
