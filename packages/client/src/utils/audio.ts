import { SoundPreset, type GameSoundId } from '../types';
...
export const playSoundEffect = (type: GameSoundId, preset: SoundPreset = SoundPreset.FUN) => {
  try {
      ...
      default:
        ...
        switch (type) {
          ...
          case 'win':
            ...
            createOsc(ctx, 'sine', 1046.5, now + 0.3, 0.4, 0.1);
            break;
        }
        break;
    }
