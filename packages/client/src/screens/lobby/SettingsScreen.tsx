            ...
            <div className="grid grid-cols-2 gap-2">
              {(
                [
                  ...
                  [GameMode.TRANSLATION, t.gameModeTranslation ?? 'Translation', <Languages size={16} />],
                  [GameMode.SYNONYMS, t.gameModeSynonyms ?? 'Synonyms', <GraduationCap size={16} />],
                ...
                return (
                  ...
                  >
                    <div className="space-y-1">
                      ...
                      <div className={`text-[9px] font-normal leading-snug ${active ? 'opacity-90' : 'opacity-50'}`}>
                        {hint}
                      </div>
                    </div>
                  </button>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <input
                      ...
                      onBlur={() => {
                        const clamped = Math.max(30, Math.min(180, Math.round(localRoundTime / 10) * 10));
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <input
                      ...
                      onBlur={() => {
                        const clamped = Math.max(10, Math.min(100, Math.round(localScoreToWin / 5) * 5));
